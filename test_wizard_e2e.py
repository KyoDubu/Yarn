...
def main() -> int:
    ...
    with sync_playwright() as pw:
        ...
        page.click('[data-wz="next"]')
        # Step 4: species -> elf, then choose Shadar-Kai in the right context panel
        page.click('[data-wz="pick:species:elf"]')
        check("species context panel appears", page.query_selector(".wz-context") is not None)
        check("species context identifies Elf", "Elf" in page.inner_text(".wz-context"))
